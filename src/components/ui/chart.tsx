...
`,
  ...
  return (
    // biome-ignore lint/security/noDangerouslySetInnerHtml: CSS custom properties are safe — no user input
    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload
          ...
          // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: shadcn chart template nesting
          .map((item, index) => {
